...
type StopGeom struct {
	...
	LevelId                    *string
	PlatformCode               *string
	StopTimes                  []StopTimesGeom         `gorm:"foreignKey:StopId;references:StopId"`
	FareRulesOriginID          FareRulesGeom           `gorm:"foreignKey:OriginId;references:ZoneId"`
	FareRulesDestinationID     FareRulesGeom           `gorm:"foreignKey:DestinationId;references:ZoneId"`
	FareRulesContainsId        FareRulesGeom           `gorm:"foreignKey:ContainsId;references:ZoneId"`
	FareLegJoinRulesFromStopID FareLegJoinRulesGeom    `gorm:"foreignKey:FromStopId;references:StopId"`
	FareLegJoinRulesToStopID   FareLegJoinRulesGeom    `gorm:"foreignKey:ToStopId;references:StopId"`
	StopArea                   []StopAreaGeom          `gorm:"foreignKey:StopId;references:StopId"`
	TransferFromStopID         []TransferGeom          `gorm:"foreignKey:FromStopId;references:StopId"`
	TransferToStopID           []TransferGeom          `gorm:"foreignKey:ToStopId;references:StopId"`
